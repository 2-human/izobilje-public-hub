...
I18N.en = {
    ...
    calendar: `
      <style>.cal-h{font-size:.72rem;font-weight:700;letter-spacing:.14em;text-transform:uppercase;color:var(--ink-muted);margin:0 0 .8rem}.cal-mx{margin:1.8rem 0 2.2rem}.cal-mx__grid{display:grid;gap:.9rem;grid-template-columns:repeat(auto-fit,minmax(15rem,1fr))}.cal-mx__c{background:var(--bg-alt);border-radius:10px;padding:.9rem 1rem}.cal-mx__c h3{font-family:var(--font-display);font-size:1rem;margin:0 0 .35rem;color:var(--ink)}.cal-mx__c p{margin:0;font-size:.85rem;line-height:1.5;color:var(--ink-muted)}.cal-day{font-family:var(--font-display);font-size:1.3rem;color:var(--ink);margin:2rem 0 .8rem;border-bottom:1px solid var(--hairline);padding-bottom:.4rem}.cal-day span{font-size:.85rem;color:var(--ink-muted);font-family:Inter,sans-serif;margin-left:.5rem}.cal-slot{background:#fff;border:1px solid var(--hairline);border-radius:10px;padding:1.1rem 1.2rem;margin-bottom:.9rem}.cal-slot--rest{background:var(--bg-alt);border-style:dashed;color:var(--ink-muted);text-align:center}.cal-slot--rest p{margin:0;font-size:.9rem}.cal-slot__top{display:flex;flex-wrap:wrap;align-items:center;gap:.5rem;margin-bottom:.5rem}.cal-when{font-size:.72rem;font-weight:700;letter-spacing:.08em;text-transform:uppercase;color:var(--ink-muted)}.cal-stream{font-size:.72rem;font-weight:700;padding:.15rem .5rem;border-radius:.3rem}.cal-fmt{font-size:.75rem;color:var(--ink-muted)}.cal-status{font-size:.66rem;font-weight:700;letter-spacing:.08em;text-transform:uppercase;padding:.15rem .45rem;border-radius:.3rem;margin-left:auto}.cal-status--draft{background:var(--accent-soft);color:var(--accent-strong)}.cal-status--needs-owner{background:#fbe9e7;color:#b03a2e}.cal-status--conditional{background:#f6ecd6;color:#8a6a14}.cal-title{font-family:var(--font-display);font-size:1.1rem;margin:0 0 .7rem;color:var(--ink)}.cal-lab{font-size:.68rem;font-weight:700;letter-spacing:.1em;text-transform:uppercase;color:var(--ink-muted);margin:.8rem 0 .3rem}.cal-media{margin:0;font-size:.9rem;color:var(--ink);line-height:1.5}.cal-copy{margin:0;background:var(--bg-alt);border-radius:8px;padding:.8rem .9rem;font-size:.85rem;line-height:1.55;white-space:pre-wrap;font-family:Inter,sans-serif;color:var(--ink)}.cal-slot__meta{display:flex;flex-wrap:wrap;gap:1.2rem;margin-top:.8rem;font-size:.8rem;color:var(--ink-muted)}.cal-note{margin:.7rem 0 0;font-size:.82rem;color:#8a6a14;background:#f6ecd6;border-radius:6px;padding:.5rem .7rem}.cal-media__slot{margin:.8rem 0 0;font-size:.78rem;color:var(--ink-muted);border-top:1px dashed var(--hairline);padding-top:.6rem}.cal-open{border-left:3px solid var(--hairline);padding:.1rem 0 .1rem 1rem;margin-bottom:1.1rem}.cal-open h3{font-family:var(--font-display);font-size:1rem;margin:0 0 .3rem;color:var(--ink)}.cal-open p{margin:0;font-size:.88rem;line-height:1.55;color:var(--ink-muted)}.cal-buffer{margin-top:2rem;background:var(--bg-alt);border-radius:10px;padding:1rem 1.1rem}.cal-buffer p:last-child{margin:0;font-size:.88rem;line-height:1.55;color:var(--ink)}.cal-order{border:1px solid var(--hairline);border-radius:10px;overflow:hidden;background:#fff}.cal-order__r{display:grid;grid-template-columns:2.2rem 12rem 1fr 12rem;gap:.6rem;align-items:center;padding:.5rem .8rem;font-size:.83rem;border-bottom:1px solid var(--hairline)}.cal-order__r:last-child{border-bottom:0}.cal-order__r--out{background:#fbf6ea;color:var(--ink-muted)}.cal-order__n{font-weight:700;color:var(--accent-strong)}.cal-order__r--out .cal-order__n{color:#8a6a14}.cal-order__f{font-size:.75rem;color:#8a6a14;text-align:right}@media (max-width:46rem){.cal-order__r{grid-template-columns:2rem 1fr;row-gap:.2rem}.cal-order__f{grid-column:1/-1;text-align:left}}</style><div class="brief"><p class="brief__eyebrow">Social · calendar</p><h1>Social calendar</h1><p class="brief__lede">Everything is video, and someone from the Izobilje community speaks — deliberately not always Jovan. Nothing here is scheduled: these are drafts for the team to finalise.</p><div class="brief__body"><p>Comment on any slot to leave notes, and attach the photo or video for that post directly in the comment.</p></div><div class="cal-mx"><p class="cal-h">The matrix</p><div class="cal-mx__grid"><div class="cal-mx__c" style="border-top:3px solid #c0392b"><h3>Fires</h3><p>Weekly recap plus urgent posts as they arise, and the pending decision on daily field reporting.</p></div><div class="cal-mx__c" style="border-top:3px solid #2f8f5b"><h3>Reforestation</h3><p>One post a week: a structured series from the start of the project to today, then weekly updates. The amount raised is stated publicly at every checkpoint.</p></div><div class="cal-mx__c" style="border-top:3px solid #7a6cc4"><h3>Izobilje</h3><p>One longer video per project, later cut into shorter pieces.</p></div><div class="cal-mx__c" style="border-top:3px solid #b7791f"><h3>The ranch</h3><p>A series on building and living at the ranch: the history, up to today, then something new each week.</p></div><div class="cal-mx__c" style="border-top:3px solid #2b7a9b"><h3>The camp</h3><p>Semi-structured guest interviews: who came, why, what the experience was like, and what they leave with.</p></div><div class="cal-mx__c" style="border-top:3px solid #5b7c3a"><h3>The sands</h3><p>Stories, legends and the natural history of the area. The trees of the sands, Devojački bunar.</p></div></div></div><p class="cal-day">Wednesday <span>2026-08-19</span></p><div class="cal-slot" id="slot-2026-08-19-morning" style="border-left:4px solid #c0392b"><div class="cal-slot__top"><span class="cal-when">Morning</span><span class="cal-stream" style="background:#c0392b1f;color:#c0392b">Fires</span><span class="cal-fmt">Reel + feed post</span><span class="cal-status cal-status--needs-owner">Needs an owner</span></div><h3 class="cal-title">Fires: field information from Tuesday</h3><p class="cal-lab">To shoot</p><p class="cal-media">Video and photos from Tuesday&#x27;s field visit. The same information goes out as a static feed image and as a video reel.</p><p class="cal-lab">Draft copy (sr)</p><pre class="cal-copy">Dragi prijatelji, evo šta smo videli na terenu u utorak.<br><br>[BULLET 1 — šta je zabeleženo, gde, u koje vreme]<br>[BULLET 2 — šta se promenilo u odnosu na prethodni dan]<br>[BULLET 3 — šta znamo pouzdano, a šta još ne]<br><br>Izveštavamo samo ono čemu smo direktno svedočili ili što imamo iz prve ruke. 🌲</pre><div class="cal-slot__meta"><span><b>Owner:</b> TBD — ko preuzima snimanje i prikupljanje informacija?</span><span><b>Speaker:</b> TBD — neko iz zajednice</span></div><p class="cal-media__slot">Attach the photo or video for this post as a comment on this card.</p></div><div class="cal-slot" id="slot-2026-08-19-afternoon" style="border-left:4px solid #2f8f5b"><div class="cal-slot__top"><span class="cal-when">Afternoon</span><span class="cal-stream" style="background:#2f8f5b1f;color:#2f8f5b">Reforestation</span><span class="cal-fmt">Reel</span><span class="cal-status cal-status--needs-owner">Needs an owner</span></div><h3 class="cal-title">Seedlings + ranch: the land where planting will happen</h3><p class="cal-lab">To shoot</p><p class="cal-media">Footage of the ranch land where seedlings will be planted, with a short explanation of how the preparation process works.</p><p class="cal-lab">Draft copy (sr)</p><pre class="cal-copy">Ovo je zemljište na kome počinje priprema.<br><br>[KRATKO OBJAŠNJENJE — kako izgleda proces: priprema, uzgoj, školovanje, nega mladica]<br><br>Podsećamo: prva faza se odvija na ranču Šumski Mir, gde se sadni materijal priprema za buduće faze obnove. Sadnja na području Specijalnog rezervata prirode ide isključivo uz koordinaciju i odobrenje upravljača, JP Vojvodinašume. 🌱</pre><div class="cal-slot__meta"><span><b>Owner:</b> TBD — ko preuzima snimanje i prikupljanje informacija?</span><span><b>Speaker:</b> TBD — neko iz zajednice</span></div><p class="cal-note">The day always ends on a positive note.</p><p class="cal-media__slot">Attach the photo or video for this post as a comment on this card.</p></div><p class="cal-day">Thursday <span>2026-08-20</span></p><div class="cal-slot" id="slot-2026-08-20-morning" style="border-left:4px solid #c0392b"><div class="cal-slot__top"><span class="cal-when">Morning</span><span class="cal-stream" style="background:#c0392b1f;color:#c0392b">Fires</span><span class="cal-fmt">Reel + feed post</span><span class="cal-status cal-status--draft">Draft</span></div><h3 class="cal-title">Fires: field information from Wednesday</h3><p class="cal-lab">To shoot</p><p class="cal-media">Video and photos from Wednesday. If there is nothing new from the field, surface one data point worth explaining.</p><p class="cal-lab">Draft copy (sr)</p><pre class="cal-copy">Stanje na terenu, sreda.<br><br>[BULLET 1 — šta je zabeleženo]<br>[BULLET 2 — šta se promenilo]<br><br>[AKO NEMA NOVINA: jedan podatak koji vredi objasniti, na primer koliko dugo traje oporavak staništa posle požara]</pre><div class="cal-slot__meta"><span><b>Owner:</b> TBD</span><span><b>Speaker:</b> TBD — neko iz zajednice</span></div><p class="cal-media__slot">Attach the photo or video for this post as a comment on this card.</p></div><div class="cal-slot" id="slot-2026-08-20-afternoon" style="border-left:4px solid #2b7a9b"><div class="cal-slot__top"><span class="cal-when">Afternoon</span><span class="cal-stream" style="background:#2b7a9b1f;color:#2b7a9b">The camp</span><span class="cal-fmt">Carousel</span><span class="cal-status cal-status--draft">Draft</span></div><h3 class="cal-title">Camp: the gathering at the table outside</h3><p class="cal-lab">To shoot</p><p class="cal-media">Photos taken on Tuesday of the atmosphere at the outdoor table. A carousel of three to five images.</p><p class="cal-lab">Draft copy (sr)</p><pre class="cal-copy">[2–3 REČENICE — ko je bio, odakle su došli, šta smo radili]<br><br>Ovakvi susreti su razlog zbog kog kamp postoji. 💚</pre><div class="cal-slot__meta"><span><b>Owner:</b> Jovan (fotografije već postoje)</span><span><b>Speaker:</b> TBD — neko iz zajednice</span></div><p class="cal-media__slot">Attach the photo or video for this post as a comment on this card.</p></div><p class="cal-day">Friday <span>2026-08-21</span></p><div class="cal-slot" id="slot-2026-08-21-morning" style="border-left:4px solid #c0392b"><div class="cal-slot__top"><span class="cal-when">Morning</span><span class="cal-stream" style="background:#c0392b1f;color:#c0392b">Fires</span><span class="cal-fmt">Reel + feed post</span><span class="cal-status cal-status--draft">Draft</span></div><h3 class="cal-title">Fires: field information from Thursday</h3><p class="cal-lab">To shoot</p><p class="cal-media">Video and photos from Thursday. If there is nothing new, surface a data point.</p><p class="cal-lab">Draft copy (sr)</p><pre class="cal-copy">Stanje na terenu, četvrtak.<br><br>[BULLET 1]<br>[BULLET 2]<br><br>[AKO NEMA NOVINA: podatak koji vredi objasniti]</pre><div class="cal-slot__meta"><span><b>Owner:</b> TBD</span><span><b>Speaker:</b> TBD — neko iz zajednice</span></div><p class="cal-media__slot">Attach the photo or video for this post as a comment on this card.</p></div><div class="cal-slot" id="slot-2026-08-21-afternoon" style="border-left:4px solid #5b7c3a"><div class="cal-slot__top"><span class="cal-when">Afternoon</span><span class="cal-stream" style="background:#5b7c3a1f;color:#5b7c3a">The sands</span><span class="cal-fmt">Reel</span><span class="cal-status cal-status--draft">Draft</span></div><h3 class="cal-title">Devojački bunar: a story from the area</h3><p class="cal-lab">To shoot</p><p class="cal-media">A fitting photo or clip of Devojački bunar, with the anecdote or legend told over it.</p><p class="cal-lab">Draft copy (sr)</p><pre class="cal-copy">[ANEGDOTA ILI LEGENDA — odakle ime, šta se priča u kraju]<br><br>Peščara nije samo pesak i borovi. Ovde svako mesto ima ime i priču. 🌲</pre><div class="cal-slot__meta"><span><b>Owner:</b> TBD</span><span><b>Speaker:</b> TBD — neko iz zajednice</span></div><p class="cal-media__slot">Attach the photo or video for this post as a comment on this card.</p></div><p class="cal-day">Saturday <span>2026-08-22</span></p><div class="cal-slot cal-slot--rest"><p>No posting. Replying to comments and messages.</p></div><p class="cal-day">Sunday <span>2026-08-23</span></p><div class="cal-slot cal-slot--rest"><p>No posting. Replying to comments and messages.</p></div><p class="cal-day">Monday <span>2026-08-24</span></p><div class="cal-slot" id="slot-2026-08-24-morning" style="border-left:4px solid #c0392b"><div class="cal-slot__top"><span class="cal-when">Morning</span><span class="cal-stream" style="background:#c0392b1f;color:#c0392b">Fires</span><span class="cal-fmt">Reel + feed post</span><span class="cal-status cal-status--draft">Draft</span></div><h3 class="cal-title">Fires: recap of the whole week</h3><p class="cal-lab">To shoot</p><p class="cal-media">An edit of the footage and photos gathered over the week.</p><p class="cal-lab">Draft copy (sr)</p><pre class="cal-copy">Šta se dešavalo ove nedelje.<br><br>[REKAPITULACIJA PO DANIMA — utorak, sreda, četvrtak, petak]<br><br>[STANJE PRIKUPLJENIH SREDSTAVA — iznos na dan objave]<br><br>Hvala svima koji su bili uz nas ove nedelje. 💚</pre><div class="cal-slot__meta"><span><b>Owner:</b> TBD</span><span><b>Speaker:</b> TBD — neko iz zajednice</span></div><p class="cal-media__slot">Attach the photo or video for this post as a comment on this card.</p></div><div class="cal-slot" id="slot-2026-08-24-afternoon" style="border-left:4px solid #5b7c3a"><div class="cal-slot__top"><span class="cal-when">Afternoon</span><span class="cal-stream" style="background:#5b7c3a1f;color:#5b7c3a">The sands</span><span class="cal-fmt">Feed post</span><span class="cal-status cal-status--conditional">Conditional</span></div><h3 class="cal-title">Trees of the sands: the first tree from the seedling stock</h3><p class="cal-lab">To shoot</p><p class="cal-media">A photo of the first sapling from the stock to be planted, alongside a photo of a mature tree of the same species from the field.</p><p class="cal-lab">Draft copy (sr)</p><pre class="cal-copy">[NARODNO IME] — [NAUČNO IME]<br><br>[KARAKTERISTIKE]<br>[KOLIKO MU TREBA DA IZRASTE / KOJOM BRZINOM RASTE]<br>[ZAŠTO ĆEMO GA SADITI]<br><br>Izbor vrsta se pravi prema staništu i u dogovoru sa strukom. 🌳</pre><div class="cal-slot__meta"><span><b>Owner:</b> TBD</span><span><b>Speaker:</b> TBD — neko iz zajednice</span></div><p class="cal-note">CONDITIONAL: publish only if the species facts are reliable and checked. If they are not settled by Monday, change the topic.</p><p class="cal-media__slot">Attach the photo or video for this post as a comment on this card.</p></div><p class="cal-h" style="margin-top:2rem">Open questions</p><div class="cal-open"><h3>Do we report on the fire more intensively?</h3><p>The proposal is to report everything we witness directly or have reliably first-hand, on the grounds that information and evidence are the strongest way to build legitimacy right now. If adopted, that means a short video and photos from the field every day, with bullet points on what was witnessed, going straight to posts and reels.</p></div><div class="cal-open"><h3>Who takes the shooting and information-gathering per slot?</h3><p>Neither Wednesday slot has anyone assigned to shoot and gather the information. Until that is assigned, those slots are not deliverable.</p></div><div class="cal-open"><h3>Who speaks on camera?</h3><p>Everything is video and spoken by someone from the Izobilje community, deliberately not always Jovan. A speaker needs naming for each slot.</p></div><p class="cal-h" style="margin-top:2rem">Scheduling order</p><div class="cal-order"><div class="cal-order__r"><span class="cal-order__n">1</span><span>2026-08-19 · Morning</span><span>Fires · Reel</span><span class="cal-order__f"></span></div><div class="cal-order__r"><span class="cal-order__n">2</span><span>2026-08-19 · Morning</span><span>Fires · Feed post</span><span class="cal-order__f"></span></div><div class="cal-order__r"><span class="cal-order__n">3</span><span>2026-08-19 · Afternoon</span><span>Reforestation · Reel</span><span class="cal-order__f"></span></div><div class="cal-order__r"><span class="cal-order__n">4</span><span>2026-08-20 · Morning</span><span>Fires · Reel</span><span class="cal-order__f"></span></div><div class="cal-order__r"><span class="cal-order__n">5</span><span>2026-08-20 · Morning</span><span>Fires · Feed post</span><span class="cal-order__f"></span></div><div class="cal-order__r"><span class="cal-order__n">6</span><span>2026-08-20 · Afternoon</span><span>The camp · Carousel</span><span class="cal-order__f"></span></div><div class="cal-order__r"><span class="cal-order__n">7</span><span>2026-08-21 · Morning</span><span>Fires · Reel</span><span class="cal-order__f"></span></div><div class="cal-order__r"><span class="cal-order__n">8</span><span>2026-08-21 · Morning</span><span>Fires · Feed post</span><span class="cal-order__f"></span></div><div class="cal-order__r"><span class="cal-order__n">9</span><span>2026-08-21 · Afternoon</span><span>The sands · Reel</span><span class="cal-order__f"></span></div><div class="cal-order__r"><span class="cal-order__n">10</span><span>2026-08-24 · Morning</span><span>Fires · Reel</span><span class="cal-order__f"></span></div><div class="cal-order__r cal-order__r--out"><span class="cal-order__n">11</span><span>2026-08-24 · Morning</span><span>Fires · Feed post</span><span class="cal-order__f">beyond the 10-post limit</span></div><div class="cal-order__r cal-order__r--out"><span class="cal-order__n">12</span><span>2026-08-24 · Afternoon</span><span>The sands · Feed post</span><span class="cal-order__f">beyond the 10-post limit</span></div></div><p class="cal-note" style="margin:.8rem 0 0">The two outside the limit are Monday's feed duplicate, which repeats the recap reel, and Monday's tree post, which is conditional on the species facts and should not be pre-scheduled. The limit costs nothing real this week.</p><div class="cal-buffer"><p class="cal-h">Buffer</p><p>Connected as <b>team@izobilje.com</b> (Europe/Belgrade), one channel: Instagram <b>sumski.mir</b>. The plan allows <b>10 scheduled posts</b>; this week needs <b>12</b>, because each “Reel + feed post” slot is two posts. Either raise the plan, or publish the fire slots as a reel only.</p></div></div>`,
...
I18N.sr = {
  ...
  calendar: `
      <style>.cal-h{font-size:.72rem;font-weight:700;letter-spacing:.14em;text-transform:uppercase;color:var(--ink-muted);margin:0 0 .8rem}.cal-mx{margin:1.8rem 0 2.2rem}.cal-mx__grid{display:grid;gap:.9rem;grid-template-columns:repeat(auto-fit,minmax(15rem,1fr))}.cal-mx__c{background:var(--bg-alt);border-radius:10px;padding:.9rem 1rem}.cal-mx__c h3{font-family:var(--font-display);font-size:1rem;margin:0 0 .35rem;color:var(--ink)}.cal-mx__c p{margin:0;font-size:.85rem;line-height:1.5;color:var(--ink-muted)}.cal-day{font-family:var(--font-display);font-size:1.3rem;color:var(--ink);margin:2rem 0 .8rem;border-bottom:1px solid var(--hairline);padding-bottom:.4rem}.cal-day span{font-size:.85rem;color:var(--ink-muted);font-family:Inter,sans-serif;margin-left:.5rem}.cal-slot{background:#fff;border:1px solid var(--hairline);border-radius:10px;padding:1.1rem 1.2rem;margin-bottom:.9rem}.cal-slot--rest{background:var(--bg-alt);border-style:dashed;color:var(--ink-muted);text-align:center}.cal-slot--rest p{margin:0;font-size:.9rem}.cal-slot__top{display:flex;flex-wrap:wrap;align-items:center;gap:.5rem;margin-bottom:.5rem}.cal-when{font-size:.72rem;font-weight:700;letter-spacing:.08em;text-transform:uppercase;color:var(--ink-muted)}.cal-stream{font-size:.72rem;font-weight:700;padding:.15rem .5rem;border-radius:.3rem}.cal-fmt{font-size:.75rem;color:var(--ink-muted)}.cal-status{font-size:.66rem;font-weight:700;letter-spacing:.08em;text-transform:uppercase;padding:.15rem .45rem;border-radius:.3rem;margin-left:auto}.cal-status--draft{background:var(--accent-soft);color:var(--accent-strong)}.cal-status--needs-owner{background:#fbe9e7;color:#b03a2e}.cal-status--conditional{background:#f6ecd6;color:#8a6a14}.cal-title{font-family:var(--font-display);font-size:1.1rem;margin:0 0 .7rem;color:var(--ink)}.cal-lab{font-size:.68rem;font-weight:700;letter-spacing:.1em;text-transform:uppercase;color:var(--ink-muted);margin:.8rem 0 .3rem}.cal-media{margin:0;font-size:.9rem;color:var(--ink);line-height:1.5}.cal-copy{margin:0;background:var(--bg-alt);border-radius:8px;padding:.8rem .9rem;font-size:.85rem;line-height:1.55;white-space:pre-wrap;font-family:Inter,sans-serif;color:var(--ink)}.cal-slot__meta{display:flex;flex-wrap:wrap;gap:1.2rem;margin-top:.8rem;font-size:.8rem;color:var(--ink-muted)}.cal-note{margin:.7rem 0 0;font-size:.82rem;color:#8a6a14;background:#f6ecd6;border-radius:6px;padding:.5rem .7rem}.cal-media__slot{margin:.8rem 0 0;font-size:.78rem;color:var(--ink-muted);border-top:1px dashed var(--hairline);padding-top:.6rem}.cal-open{border-left:3px solid var(--hairline);padding:.1rem 0 .1rem 1rem;margin-bottom:1.1rem}.cal-open h3{font-family:var(--font-display);font-size:1rem;margin:0 0 .3rem;color:var(--ink)}.cal-open p{margin:0;font-size:.88rem;line-height:1.55;color:var(--ink-muted)}.cal-buffer{margin-top:2rem;background:var(--bg-alt);border-radius:10px;padding:1rem 1.1rem}.cal-buffer p:last-child{margin:0;font-size:.88rem;line-height:1.55;color:var(--ink)}.cal-order{border:1px solid var(--hairline);border-radius:10px;overflow:hidden;background:#fff}.cal-order__r{display:grid;grid-template-columns:2.2rem 12rem 1fr 12rem;gap:.6rem;align-items:center;padding:.5rem .8rem;font-size:.83rem;border-bottom:1px solid var(--hairline)}.cal-order__r:last-child{border-bottom:0}.cal-order__r--out{background:#fbf6ea;color:var(--ink-muted)}.cal-order__n{font-weight:700;color:var(--accent-strong)}.cal-order__r--out .cal-order__n{color:#8a6a14}.cal-order__f{font-size:.75rem;color:#8a6a14;text-align:right}@media (max-width:46rem){.cal-order__r{grid-template-columns:2rem 1fr;row-gap:.2rem}.cal-order__f{grid-column:1/-1;text-align:left}}</style><div class="brief"><p class="brief__eyebrow">Društvene mreže · kalendar</p><h1>Kalendar objava</h1><p class="brief__lede">Sve je video i priča neko iz zajednice Izobilje, namerno ne uvek Jovan. Ništa ovde nije zakazano: ovo su nacrti koje tim finalizuje.</p><div class="brief__body"><p>Komentariši bilo koji termin da ostaviš napomenu, i zakači fotografiju ili video za tu objavu direktno u komentaru.</p></div><div class="cal-mx"><p class="cal-h">Matrica</p><div class="cal-mx__grid"><div class="cal-mx__c" style="border-top:3px solid #c0392b"><h3>Požari</h3><p>Nedeljni recap + hitne objave u toku nedelje. Uz odluku o dnevnom izveštavanju sa terena.</p></div><div class="cal-mx__c" style="border-top:3px solid #2f8f5b"><h3>Pošumljavanje</h3><p>Jedan post nedeljno. Serija koja strukturirano ide od početka projekta do danas, pa nedeljni update. Na svakom checkpointu javno stanje prikupljenih sredstava.</p></div><div class="cal-mx__c" style="border-top:3px solid #7a6cc4"><h3>Izobilje</h3><p>Po jedan duži video o svakom projektu, koji se posle seče na kraće delove.</p></div><div class="cal-mx__c" style="border-top:3px solid #b7791f"><h3>Ranč</h3><p>Serija o gradnji i životu na ranču: istorija, pa do danas, pa svake nedelje nešto novo.</p></div><div class="cal-mx__c" style="border-top:3px solid #2b7a9b"><h3>Kamp</h3><p>Polustrukturirani intervjui sa gostima: ko je došao, zašto, kakvo je iskustvo i sa čime odlazi.</p></div><div class="cal-mx__c" style="border-top:3px solid #5b7c3a"><h3>Peščara</h3><p>Priče, legende i prirodna istorija kraja. Drveće peščare, Devojački bunar.</p></div></div></div><p class="cal-day">Sreda <span>2026-08-19</span></p><div class="cal-slot" id="slot-2026-08-19-morning" style="border-left:4px solid #c0392b"><div class="cal-slot__top"><span class="cal-when">Pre podne</span><span class="cal-stream" style="background:#c0392b1f;color:#c0392b">Požari</span><span class="cal-fmt">Reel + feed post</span><span class="cal-status cal-status--needs-owner">Treba dodeliti</span></div><h3 class="cal-title">Požari: informacije sa terena od utorka</h3><p class="cal-lab">Šta se snima</p><p class="cal-media">Snimak i fotografije sa terena od utorka. Ista informacija ide kao statična slika na feed i kao reel sa videom.</p><p class="cal-lab">Nacrt teksta</p><pre class="cal-copy">Dragi prijatelji, evo šta smo videli na terenu u utorak.<br><br>[BULLET 1 — šta je zabeleženo, gde, u koje vreme]<br>[BULLET 2 — šta se promenilo u odnosu na prethodni dan]<br>[BULLET 3 — šta znamo pouzdano, a šta još ne]<br><br>Izveštavamo samo ono čemu smo direktno svedočili ili što imamo iz prve ruke. 🌲</pre><div class="cal-slot__meta"><span><b>Zadužen:</b> TBD — ko preuzima snimanje i prikupljanje informacija?</span><span><b>Govori:</b> TBD — neko iz zajednice</span></div><p class="cal-media__slot">Zakači fotografiju ili video za ovu objavu kao komentar na ovu karticu.</p></div><div class="cal-slot" id="slot-2026-08-19-afternoon" style="border-left:4px solid #2f8f5b"><div class="cal-slot__top"><span class="cal-when">Posle podne</span><span class="cal-stream" style="background:#2f8f5b1f;color:#2f8f5b">Pošumljavanje</span><span class="cal-fmt">Reel</span><span class="cal-status cal-status--needs-owner">Treba dodeliti</span></div><h3 class="cal-title">Mladice + Ranč: zemljište na kome će se saditi</h3><p class="cal-lab">Šta se snima</p><p class="cal-media">Snimak zemljišta na ranču na kome će se saditi mladice. Kratko objašnjenje kako izgleda proces pripreme.</p><p class="cal-lab">Nacrt teksta</p><pre class="cal-copy">Ovo je zemljište na kome počinje priprema.<br><br>[KRATKO OBJAŠNJENJE — kako izgleda proces: priprema, uzgoj, školovanje, nega mladica]<br><br>Podsećamo: prva faza se odvija na ranču Šumski Mir, gde se sadni materijal priprema za buduće faze obnove. Sadnja na području Specijalnog rezervata prirode ide isključivo uz koordinaciju i odobrenje upravljača, JP Vojvodinašume. 🌱</pre><div class="cal-slot__meta"><span><b>Zadužen:</b> TBD — ko preuzima snimanje i prikupljanje informacija?</span><span><b>Govori:</b> TBD — neko iz zajednice</span></div><p class="cal-note">Dan uvek završavamo pozitivno.</p><p class="cal-media__slot">Zakači fotografiju ili video za ovu objavu kao komentar na ovu karticu.</p></div><p class="cal-day">Četvrtak <span>2026-08-20</span></p><div class="cal-slot" id="slot-2026-08-20-morning" style="border-left:4px solid #c0392b"><div class="cal-slot__top"><span class="cal-when">Pre podne</span><span class="cal-stream" style="background:#c0392b1f;color:#c0392b">Požari</span><span class="cal-fmt">Reel + feed post</span><span class="cal-status cal-status--draft">Nacrt</span></div><h3 class="cal-title">Požari: informacije sa terena od srede</h3><p class="cal-lab">Šta se snima</p><p class="cal-media">Snimak i fotografije od srede. Ako nema novina sa terena, izvlačimo jedan podatak koji vredi objasniti.</p><p class="cal-lab">Nacrt teksta</p><pre class="cal-copy">Stanje na terenu, sreda.<br><br>[BULLET 1 — šta je zabeleženo]<br>[BULLET 2 — šta se promenilo]<br><br>[AKO NEMA NOVINA: jedan podatak koji vredi objasniti, na primer koliko dugo traje oporavak staništa posle požara]</pre><div class="cal-slot__meta"><span><b>Zadužen:</b> TBD</span><span><b>Govori:</b> TBD — neko iz zajednice</span></div><p class="cal-media__slot">Zakači fotografiju ili video za ovu objavu kao komentar na ovu karticu.</p></div><div class="cal-slot" id="slot-2026-08-20-afternoon" style="border-left:4px solid #2b7a9b"><div class="cal-slot__top"><span class="cal-when">Posle podne</span><span class="cal-stream" style="background:#2b7a9b1f;color:#2b7a9b">Kamp</span><span class="cal-fmt">Carousel</span><span class="cal-status cal-status--draft">Nacrt</span></div><h3 class="cal-title">Kamp: susret za stolom napolju</h3><p class="cal-lab">Šta se snima</p><p class="cal-media">Fotografije napravljene u utorak, atmosfera za stolom napolju. Karusel od 3 do 5 slika.</p><p class="cal-lab">Nacrt teksta</p><pre class="cal-copy">[2–3 REČENICE — ko je bio, odakle su došli, šta smo radili]<br><br>Ovakvi susreti su razlog zbog kog kamp postoji. 💚</pre><div class="cal-slot__meta"><span><b>Zadužen:</b> Jovan (fotografije već postoje)</span><span><b>Govori:</b> TBD — neko iz zajednice</span></div><p class="cal-media__slot">Zakači fotografiju ili video za ovu objavu kao komentar na ovu karticu.</p></div><p class="cal-day">Petak <span>2026-08-21</span></p><div class="cal-slot" id="slot-2026-08-21-morning" style="border-left:4px solid #c0392b"><div class="cal-slot__top"><span class="cal-when">Pre podne</span><span class="cal-stream" style="background:#c0392b1f;color:#c0392b">Požari</span><span class="cal-fmt">Reel + feed post</span><span class="cal-status cal-status--draft">Nacrt</span></div><h3 class="cal-title">Požari: informacije sa terena od četvrtka</h3><p class="cal-lab">Šta se snima</p><p class="cal-media">Snimak i fotografije od četvrtka. Ako nema novina, izvlačimo podatak.</p><p class="cal-lab">Nacrt teksta</p><pre class="cal-copy">Stanje na terenu, četvrtak.<br><br>[BULLET 1]<br>[BULLET 2]<br><br>[AKO NEMA NOVINA: podatak koji vredi objasniti]</pre><div class="cal-slot__meta"><span><b>Zadužen:</b> TBD</span><span><b>Govori:</b> TBD — neko iz zajednice</span></div><p class="cal-media__slot">Zakači fotografiju ili video za ovu objavu kao komentar na ovu karticu.</p></div><div class="cal-slot" id="slot-2026-08-21-afternoon" style="border-left:4px solid #5b7c3a"><div class="cal-slot__top"><span class="cal-when">Posle podne</span><span class="cal-stream" style="background:#5b7c3a1f;color:#5b7c3a">Peščara</span><span class="cal-fmt">Reel</span><span class="cal-status cal-status--draft">Nacrt</span></div><h3 class="cal-title">Devojački bunar: priča iz kraja</h3><p class="cal-lab">Šta se snima</p><p class="cal-media">Odgovarajuća fotografija ili snimak Devojačkog bunara. Uz nju se priča anegdota ili legenda.</p><p class="cal-lab">Nacrt teksta</p><pre class="cal-copy">[ANEGDOTA ILI LEGENDA — odakle ime, šta se priča u kraju]<br><br>Peščara nije samo pesak i borovi. Ovde svako mesto ima ime i priču. 🌲</pre><div class="cal-slot__meta"><span><b>Zadužen:</b> TBD</span><span><b>Govori:</b> TBD — neko iz zajednice</span></div><p class="cal-media__slot">Zakači fotografiju ili video za ovu objavu kao komentar na ovu karticu.</p></div><p class="cal-day">Subota <span>2026-08-22</span></p><div class="cal-slot cal-slot--rest"><p>Bez objava. Odgovaramo na komentare i poruke.</p></div><p class="cal-day">Nedelja <span>2026-08-23</span></p><div class="cal-slot cal-slot--rest"><p>Bez objava. Odgovaramo na komentare i poruke.</p></div><p class="cal-day">Ponedeljak <span>2026-08-24</span></p><div class="cal-slot" id="slot-2026-08-24-morning" style="border-left:4px solid #c0392b"><div class="cal-slot__top"><span class="cal-when">Pre podne</span><span class="cal-stream" style="background:#c0392b1f;color:#c0392b">Požari</span><span class="cal-fmt">Reel + feed post</span><span class="cal-status cal-status--draft">Nacrt</span></div><h3 class="cal-title">Požari: recap cele nedelje</h3><p class="cal-lab">Šta se snima</p><p class="cal-media">Montaža snimaka i fotografija prikupljenih tokom nedelje.</p><p class="cal-lab">Nacrt teksta</p><pre class="cal-copy">Šta se dešavalo ove nedelje.<br><br>[REKAPITULACIJA PO DANIMA — utorak, sreda, četvrtak, petak]<br><br>[STANJE PRIKUPLJENIH SREDSTAVA — iznos na dan objave]<br><br>Hvala svima koji su bili uz nas ove nedelje. 💚</pre><div class="cal-slot__meta"><span><b>Zadužen:</b> TBD</span><span><b>Govori:</b> TBD — neko iz zajednice</span></div><p class="cal-media__slot">Zakači fotografiju ili video za ovu objavu kao komentar na ovu karticu.</p></div><div class="cal-slot" id="slot-2026-08-24-afternoon" style="border-left:4px solid #5b7c3a"><div class="cal-slot__top"><span class="cal-when">Posle podne</span><span class="cal-stream" style="background:#5b7c3a1f;color:#5b7c3a">Peščara</span><span class="cal-fmt">Feed post</span><span class="cal-status cal-status--conditional">Uslovno</span></div><h3 class="cal-title">Drveće peščare: prvo drvo iz fonda mladica</h3><p class="cal-lab">Šta se snima</p><p class="cal-media">Fotografija prve sadnice iz fonda mladica koje ćemo saditi, uz fotografiju odraslog drveta iste vrste sa terena.</p><p class="cal-lab">Nacrt teksta</p><pre class="cal-copy">[NARODNO IME] — [NAUČNO IME]<br><br>[KARAKTERISTIKE]<br>[KOLIKO MU TREBA DA IZRASTE / KOJOM BRZINOM RASTE]<br>[ZAŠTO ĆEMO GA SADITI]<br><br>Izbor vrsta se pravi prema staništu i u dogovoru sa strukom. 🌳</pre><div class="cal-slot__meta"><span><b>Zadužen:</b> TBD</span><span><b>Govori:</b> TBD — neko iz zajednice</span></div><p class="cal-note">USLOVNO: objavljuje se samo ako su podaci o vrsti pouzdani i provereni. Ako do ponedeljka nisu, menjamo temu.</p><p class="cal-media__slot">Zakači fotografiju ili video za ovu objavu kao komentar na ovu karticu.</p></div><p class="cal-h" style="margin-top:2rem">Otvorena pitanja</p><div class="cal-open"><h3>Da li intenzivnije izveštavamo o požaru?</h3><p>Predlog je da počnemo da izveštavamo o svemu čemu direktno svedočimo ili imamo iz pouzdane prve ruke, jer je to najbolji način da se u ovom trenutku gradi legitimitet: informacijama i dokazima. Ako da, onda svakog dana ide mali video i slike sa terena, uz bullet points o tome čemu se svedočilo, odmah u posts i reels.</p></div><div class="cal-open"><h3>Ko preuzima snimanje po slotu?</h3><p>Za oba slota u sredu nije određeno ko snima i prikuplja informacije. Dok se to ne dodeli, ovi termini nisu izvodljivi.</p></div><div class="cal-open"><h3>Ko govori u kadru?</h3><p>Dogovoreno je da sve bude video i da priča neko iz zajednice Izobilje, i da to ne bude uvek Jovan. Za svaki slot treba odrediti govornika.</p></div><p class="cal-h" style="margin-top:2rem">Redosled zakazivanja</p><div class="cal-order"><div class="cal-order__r"><span class="cal-order__n">1</span><span>2026-08-19 · Pre podne</span><span>Požari · Reel</span><span class="cal-order__f"></span></div><div class="cal-order__r"><span class="cal-order__n">2</span><span>2026-08-19 · Pre podne</span><span>Požari · Feed post</span><span class="cal-order__f"></span></div><div class="cal-order__r"><span class="cal-order__n">3</span><span>2026-08-19 · Posle podne</span><span>Pošumljavanje · Reel</span><span class="cal-order__f"></span></div><div class="cal-order__r"><span class="cal-order__n">4</span><span>2026-08-20 · Pre podne</span><span>Požari · Reel</span><span class="cal-order__f"></span></div><div class="cal-order__r"><span class="cal-order__n">5</span><span>2026-08-20 · Pre podne</span><span>Požari · Feed post</span><span class="cal-order__f"></span></div><div class="cal-order__r"><span class="cal-order__n">6</span><span>2026-08-20 · Posle podne</span><span>Kamp · Carousel</span><span class="cal-order__f"></span></div><div class="cal-order__r"><span class="cal-order__n">7</span><span>2026-08-21 · Pre podne</span><span>Požari · Reel</span><span class="cal-order__f"></span></div><div class="cal-order__r"><span class="cal-order__n">8</span><span>2026-08-21 · Pre podne</span><span>Požari · Feed post</span><span class="cal-order__f"></span></div><div class="cal-order__r"><span class="cal-order__n">9</span><span>2026-08-21 · Posle podne</span><span>Peščara · Reel</span><span class="cal-order__f"></span></div><div class="cal-order__r"><span class="cal-order__n">10</span><span>2026-08-24 · Pre podne</span><span>Požari · Reel</span><span class="cal-order__f"></span></div><div class="cal-order__r cal-order__r--out"><span class="cal-order__n">11</span><span>2026-08-24 · Pre podne</span><span>Požari · Feed post</span><span class="cal-order__f">van limita od 10 objava</span></div><div class="cal-order__r cal-order__r--out"><span class="cal-order__n">12</span><span>2026-08-24 · Posle podne</span><span>Peščara · Feed post</span><span class="cal-order__f">van limita od 10 objava</span></div></div><p class="cal-note" style="margin:.8rem 0 0">Van limita ostaju ponedeljkova feed objava, koja ponavlja isti sadržaj kao recap reel, i ponedeljkova objava o drvetu, koja je uslovna dok podaci o vrsti nisu pouzdani i ne treba je unapred zakazivati. Limit ove nedelje praktično ništa ne košta.</p><div class="cal-buffer"><p class="cal-h">Buffer</p><p>Povezan kao <b>team@izobilje.com</b> (Europe/Belgrade), jedan kanal: Instagram <b>sumski.mir</b>. Plan dozvoljava <b>10 zakazanih objava</b>, a ovoj nedelji treba <b>12</b>, jer je svaki termin „Reel + feed post” zapravo dve objave. Ili se plan podiže, ili termini o požarima idu samo kao reel.</p></div></div>`,
...
window.HUB = {
  ...
  nav: [
    ...
    { section: "Publishing", items: [
      { view: "calendar", label: "Social calendar", badge: 8,
        icon: "<svg class='ic' viewBox='0 0 24 24' fill='none' stroke='currentColor' stroke-width='1.6'><rect x='3' y='5' width='18' height='16' rx='2'/><path d='M3 10h18M8 3v4M16 3v4'/></svg>" },
    ]},
  ...
  VIEWS: {
    ...
    calendar:  { title: "Social calendar", sub: "The matrix, and the week ahead" },
